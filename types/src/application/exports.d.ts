...
import { SmoRehearsalMark, SmoMeasureFormat, SmoBarline, SmoRepeatSymbol, SmoVolta, SmoMeasureText, SmoTempo, SmoTimeSignature } from '../smo/data/measureModifiers';
...
export declare const Smo: {
    ...
    GlobalLayoutNumberAttributesArray: import("../smo/data/scoreModifiers").GlobalLayoutNumberAttributes[];
    ...
    SuiMeasureFormatDialogVue: (parameters: import("../ui/dialogs/dialog").SuiDialogParams) => Promise<void>;
    SuiInsertMeasuresVue: (parameters: import("../ui/dialogs/dialog").SuiDialogParams) => Promise<void>;
    SuiTimeSignatureDialogVue: (parameters: import("../ui/dialogs/dialog").SuiDialogParams) => void;
    ...
    SuiEndingsDialogVue: (parameters: import("../ui/dialogs/dialog").SuiDialogParams) => void;
    ...
    SmoTempo: typeof SmoTempo;
    SmoTimeSignature: typeof SmoTimeSignature;
    ...
    SuiNavigationDom: typeof SuiNavigationDom;
};
export default Smo;
